  ...
  <drag-window class="edge-app">
    <div class="edge-app__header flex items-center justify-between">
      ...
      <div class="right-control flex">
        <div class="hide flex items-center justify-center h-[40px] w-[46px] hover:bg-[#B8B8B8]">
          <div class="line w-[12px] h-[1px] bg-black"></div>
        </div>
        <div class="full flex items-center justify-center h-[40px] w-[46px] hover:bg-[#B8B8B8]">
          <div class="w-[10px] h-[10px] border border-black rounded-sm"></div>
        </div>
        <div class="close flex items-center justify-center h-[40px] w-[46px] hover:bg-[#B8B8B8]">
...
<!--      <iframe class="w-full" src="https://www.hao123.com/" />-->
    </div>
  </drag-window>
</template>
